...
export function isRecoveryOwnedIssueOriginKind(originKind: string | null | undefined) {
  if (!originKind) return false;
  return Object.values(RECOVERY_ORIGIN_KINDS).includes(originKind as RecoveryOriginKind);
}
