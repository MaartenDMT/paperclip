// Adapter session-state helpers extracted from heartbeat.ts.
//
// Each adapter can carry its own session params across runs; these resolve the
// codec for an adapter (falling back to a generic sessionId-based codec) and
