...
| [`Fiction Director`](agents/fictiondirector.md) | Fiction department heads who own story quality, World Vault discipline, series/world continuity, release gates, and specialist routing | `codex_local`, `claude_local`, or another writing/review-capable adapter | High (lens-heavy) |
| [`Fiction Story Architect`](agents/fictionstoryarchitect.md) | Architects who design large-scale lore, World Vault structure, series arcs, factions, countries, empires, worlds, magic systems, and plot/twist engines | `codex_local`, `claude_local`, or another writing/review-capable adapter | High (lens-heavy) |
| [`Fiction Continuity Coordinator`](agents/fictioncontinuitycoordinator.md) | Coordinators who keep fiction work aligned across agents, issues, gates, World Vault artifacts, sequence continuity, and handoffs | `codex_local`, `claude_local`, or another coordination-capable adapter | Medium (coordination) |
...
- **Fiction Director** — the hire is accountable for department-level fiction quality and release decisions. Pick Fiction Director when the role must coordinate research, character, plot, worldbuilding, continuity, draft, visual/storybook, QA, and engineering handoffs while keeping the World Vault and reader-facing world coherent.
- **Fiction Story Architect** — the hire is accountable for large-scale story-world design. Pick Fiction Story Architect when the work is bigger than a scene or single draft: series sequence, world-level campaigns, countries, alliances, empires, factions, locations, multiple worlds, magic/power systems, twist pipelines, and evaluation gates.
- **Fiction Continuity Coordinator** — the hire is accountable for workflow alignment rather than creative authorship. Pick Fiction Continuity Coordinator when fiction work is falling through cracks between architects, writers, QA, product, and engineering, or when meeting outcomes and review gates need to become first-class issues with one clear next owner.
